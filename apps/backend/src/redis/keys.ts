...
export const REDIS_KEYS = {
  ...
  currentPlayer: (roomId: string) =>
    `auction:${roomId}:current_player` as const,
  ...
  currentBidder: (roomId: string) =>
    `auction:${roomId}:current_bidder` as const,
  ...
  timerDeadline: (roomId: string) =>
    `auction:${roomId}:timer_deadline` as const,
