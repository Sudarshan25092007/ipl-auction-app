...
export const FRANCHISES: readonly FranchiseMeta[] = [
  {
    name: 'Mumbai Indians',
    abbreviation: 'MI',
    primaryColor: '#0031d7ff',
    secondaryColor: '#D4AF37',
  },
  {
    name: 'Chennai Super Kings',
    abbreviation: 'CSK',
    primaryColor: '#f6ff00ff',
    secondaryColor: '#0081E9',
  },
  {
    name: 'Royal Challengers Bengaluru',
    abbreviation: 'RCB',
    primaryColor: '#f7030bff',
    secondaryColor: '#000000',
  },
  {
    name: 'Kolkata Knight Riders',
    abbreviation: 'KKR',
    primaryColor: '#7a47c8ff',
    secondaryColor: '#B3A123',
  },
  {
    name: 'Sunrisers Hyderabad',
    abbreviation: 'SRH',
    primaryColor: '#ff4800ff',
    secondaryColor: '#E8461B',
  },
  {
    name: 'Delhi Capitals',
    abbreviation: 'DC',
    primaryColor: '#0590e1ff',
  ...
  },
  {
    ...
    abbreviation: 'LSG',
    primaryColor: '#ff4000ff',
    secondaryColor: '#0057A8',
  },
  {
    name: 'Gujarat Titans',
    abbreviation: 'GT',
    primaryColor: '#120087ff',
    secondaryColor: '#AEC6CF',
  },
] as const;
...
export const FRANCHISE_MAP: Readonly<Record<FranchiseName, FranchiseMeta>> =
  Object.fromEntries(FRANCHISES.map((f) => [f.name, f])) as Record<
    FranchiseName,
    FranchiseMeta
  >;
